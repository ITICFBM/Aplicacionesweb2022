...
<body>
  ...
  <div class="container-fluid p-5 ">
    <div class="row">
          <div class="col col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6 fluid-img">
          <svg class="fluid-img" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="793" height="551.73152"
            ...
            <polygon
              ...
              fill="#2f2e41" />
            <circle cx="707.33457" cy="77.37523" r="77.37523" fill="#0f00e4" />
            <path
            ...
            <path
              ...
              transform="translate(-203.5 -174.13424)" fill="#0f00e4" />
            <path
          ...
          <div class="col col-sm-6 col-md-6 col-lg-6  col-xl-6 col-xxl-6 align-self-center">
            <h1 class="text-center">Iniciar Session</h1>
    
              <div class="card container-fluid p-4">
              <form>
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Corre Electronico:</label>
                ...
                <a href="<?=$h->get['base_url'].'../paneladmin'?>" class="btn btn-primary">Inicar Session</a>
              </form>
              </div>
